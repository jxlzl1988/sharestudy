...
<section id="menu">
  <div class="content">
    <nav>
      <a href="javascript:void(0)" id="java">java</a>
      <a href="javascript:void(0)" id="linux">linux</a>
      <a href="javascript:void(0)" id="database">数据库</a>
      <a href="javascript:void(0)" id="pattern">设计模式</a>
    </nav>
